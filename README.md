# tetsapi OpenAPI Specification
[![Build Status](https://travis-ci.org/rafayjamal/apitest.svg?branch=master)](https://travis-ci.org/rafayjamal/apitest)
...
6. If you did everything correct, https://rafayjamal.github.io/apitest/ will lead to your new docs
...
- Documentation(ReDoc): https://rafayjamal.github.io/apitest/
- SwaggerUI: https://rafayjamal.github.io/apitest/swagger-ui/
- Look full spec:
    + JSON https://rafayjamal.github.io/apitest/swagger.json
    + YAML https://rafayjamal.github.io/apitest/swagger.yaml
- Preview spec version for branch `[branch]`: https://rafayjamal.github.io/apitest/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rafayjamal.github.io/apitest/ with url from the message: `Server started <url>`
